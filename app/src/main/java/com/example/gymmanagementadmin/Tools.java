package com.example.gymmanagementadmin;
...
public class Tools {
    ...
    public static void savePref(String name, String value) {
        SharedPreferences pref = com.example.gymmanagementadmin.App.getInstance().getContext().getSharedPreferences(com.example.gymmanagementadmin.App.getInstance().getPackageName(), Context.MODE_PRIVATE);
    ...
    public static float getPrefFloat(String name, float defaultValue) {
        SharedPreferences pref = com.example.gymmanagementadmin.App.getInstance().getContext().getSharedPreferences(com.example.gymmanagementadmin.App.getInstance().getPackageName(), Context.MODE_PRIVATE);
